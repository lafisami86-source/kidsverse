      ...
      <main className="mx-auto max-w-2xl px-4 pb-12 pt-6 sm:px-6 sm:pt-8">
        <motion.div className="flex flex-col gap-6 sm:gap-8" variants={containerVariants} initial="hidden" animate="visible">
          <motion.section variants={itemVariants} className="text-center">
            ...
            <h1 className="text-2xl sm:text-3xl font-nunito font-extrabold text-kids-dark mt-2">Let&apos;s Play!</h1>
            <p className="text-sm sm:text-base text-kids-text-secondary mt-1">Choose a game, {activeProfile.name}!</p>
          </motion.section>
